...
<body>
  <div class="wrapper">
    ...
    <form action="#">
      ...
      <div class="input-box">
        <label for="">MATRICULE</label> <input type="text" placeholder="MATRICULE VOITURE" required>
      </div>
      <div class="input-box">
        <label for="">DATE RESREVATIONS </label> <input type="date" placeholder="DATE RESREVATIONS" required>
      </div> 
      <div class="button">
