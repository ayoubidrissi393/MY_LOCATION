  ...
  <div class="wrapper">
    ...
    <form  action="Ajouter-Reparable.php" method ="POST" enctype="multipart/form-data">
      ...
      <div class="input-box-check">
        ...
        <div class="check">
            <input type="checkbox" id="vidange" name="ch[]" value="vidange "> 
        <label for="vidange" class="label-check"> Vidange</label>
        </div>
        <div class="check">
            <input type="checkbox" id="pnus" name="ch[]" value="pnus ">
        <label for="pnus"  class="label-check">Mécanique</label>
        </div>
        <div class="check">
            <input type="checkbox" id="mécanique" name="ch[]" value="mécanique ">
        ...
        <label for="">DESCRIPTION</label> <textarea id="AREA" name="ch[]" rows="3" cols="40"> </textarea>
      </div> 
      <div class="button">
