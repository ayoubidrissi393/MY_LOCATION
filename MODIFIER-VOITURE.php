...
<body>
  <div class="wrapper">
    ...
    <form action="#">
      ...
      <div class="input-box">
        <label for="">Date De Circulation</label> <input type="text" placeholder="MATRICULE VOITURE" required>
      </div>
      <div class="input-box">
        <label for="">Couleur</label> <input type="text" placeholder="COULEUR" required>
      </div> 
      <div class="input-box">
        <label for="">Date De Taxe Depart</label> <input type="date" placeholder="DATE RESREVATIONS" required>
      </div> 
      <div class="input-box">
        <label for="">Date De Taxe Fin</label> <input type="date" placeholder="DATE RESREVATIONS" required>
      </div> 
      <div class="input-box">
        <label for="">Date Aassurance Depart</label> <input type="date" placeholder="DATE RESREVATIONS" required>
      </div> 
      <div class="input-box">
        <label for="">Date Aassurance Fin</label> <input type="date" placeholder="DATE RESREVATIONS" required>
      </div> 
